...
public class ShoplazzaBillingAddress {
    private String zip;
    private String area;
    ...
    public ShoplazzaBillingAddress() {
    }

    private ShoplazzaBillingAddress(Builder builder) {
        setZip(builder.zip);
    ...
    public static final class Builder {
        ...
        public ShoplazzaBillingAddress build() {
            return new ShoplazzaBillingAddress(this);
        }
    }
}